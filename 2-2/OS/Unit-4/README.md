# OS – Memory Management and Virtual Memory

## Overview

Logical vs physical address space, swapping, contiguous allocation, paging, segmentation, segmentation with paging. Demand paging, page replacement algorithms.
