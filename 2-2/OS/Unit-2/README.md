# OS – CPU Scheduling and Deadlocks

## Overview

Scheduling criteria, algorithms, multiple-processor scheduling. System calls for process management – fork, exit, wait, waitpid, exec. Deadlocks – system model, characterisation, methods (prevention, avoidance, detection, recovery).
