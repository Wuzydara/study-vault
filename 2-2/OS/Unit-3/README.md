# OS – Process Management and Synchronization

## Overview

Critical section problem, synchronisation hardware, semaphores, classical problems, monitors. IPC mechanisms – pipes, FIFOs, message queues, shared memory.
