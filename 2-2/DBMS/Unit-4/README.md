# DBMS – Normalization and Transaction Management

## Overview

Functional dependencies, normalisation up to BCNF. Transaction concept, ACID properties, states. Concurrency control – locking, timestamp, validation, multiple granularity. Recovery – log-based recovery, checkpoints.
