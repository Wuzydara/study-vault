...
Functional and non-functional requirements, user/system requirements, interface specification. Requirements document. Requirements engineering process – feasibility, elicitation, analysis, validation, management.
