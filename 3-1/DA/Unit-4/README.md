# DA – Object Segmentation

## Overview

Regression vs segmentation, supervised/unsupervised learning, tree building (regression, classification), overfitting, pruning, multiple decision trees. Time series – ARIMA, STL, feature extraction.
