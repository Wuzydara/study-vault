# DevOps – Integrating the System

## Overview

Build systems, Jenkins, build dependencies, plugins, file system layout, build slaves, triggers, job chaining, pipeline, infrastructure as code, build by dependency order, build phases.
