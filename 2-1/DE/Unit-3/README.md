# DE – Combinational Logic

## Overview

Analysis and design procedures. Binary adder-subtractor, decimal adder, binary multiplier, magnitude comparator. Decoders, encoders, multiplexers. HDL for combinational circuits.
