# DS – Stacks and Queues

## Overview

Stack – operations, array and linked representations, applications – infix/postfix/prefix, recursion. Queue – operations, array and linked representations, circular queues, dequeues.
