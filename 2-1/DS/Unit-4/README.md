...
Definitions, representations – adjacency matrix, adjacency list. Graph traversals – BFS, DFS. Shortest path – Dijkstra's algorithm. Minimum spanning trees – Prim's and Kruskal's.
