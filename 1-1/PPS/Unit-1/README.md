# PPS – Introduction to Programming

## Overview

Compilers, compiling and executing. Algorithms, Flowcharts. C basics – variables, data types, operators, expressions, storage classes, type conversion. Bitwise operations. Conditional branching and loops. I/O – scanf, printf. Command line arguments.
