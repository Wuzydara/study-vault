# PPS – Arrays, Strings, Structures and Pointers

## Overview

Arrays – one and two dimensional. Strings – handling as character arrays, string functions. Structures – defining, initializing, unions, array of structures. Pointers – definition, pointers to arrays and structures, self-referential structures.
