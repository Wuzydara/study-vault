# CAEG – Isometric Projections

## Overview

Principles, Isometric Scale, Isometric views – lines, plane figures, simple and compound solids, objects with non-isometric lines, spherical parts. Conversion between isometric and orthographic views.
