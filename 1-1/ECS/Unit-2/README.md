# ECS – Software Development

## Overview

Waterfall model, Agile. Types of languages – programming, markup, scripting. Program development – steps, flowcharts, algorithms. Data structures – definition and types.
