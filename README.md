...
**Course Objectives:** (Refer to the official syllabus document for detailed objectives.)

**Course Outcomes:** (Refer to the official syllabus document for detailed outcomes.)
...
**Unit-1: Toasted English – R.K. Narayan**
...
**Unit-2: Appro JR"D" – Sudha Murthy**
...
**Unit-3: Lessons from Online Learning**
...
**Unit-4: Art and Literature – Abdul Kalam**
...
**Unit-5: Go, Kiss the World – Subroto Bagchi**
...
**Unit-5: Memories and Asynchronous Sequential Logic**
...
**Unit-5: Hashing and Pattern Matching**
...
**Unit-2: Instruction Sets and Addressing Modes**
...
**Unit-5: I/O Organization and Pipelining**
...
**Unit-5: Financial Ratios Analysis**
...
**Unit-1: Introduction and Structures**
...
**Unit-5: File Organisation and Indexing**
...
**Unit-2: Data Link Layer and Medium Access Sublayer**
...
**Unit-2: Software development models and DevOps**
...
**Unit-5: Testing Tools and Deployment**
...
**Unit-2: Data Analytics Introduction**
...
**Unit-1: Structure of Words and Documents**
...
**Unit-3: Syntax II and Semantic Parsing I**
...
**Unit-3: Decision Trees and Ensemble**
...
**Unit-4: Normal Forms and Turing Machines**
...
**Unit-5: Turing Machine Types and Undecidability**
...
**Unit-1: Introduction and Search**
...
**Unit-2: Adversarial Search and Logic**
...
**Unit-2: Cyberspace Law and Cyber Forensics**
...
**Unit-4: Organizational Implications**
...
**Unit-3: Syntax Directed Translation and Intermediate Code**
...
**Unit-4: Run-Time Environments and Code Generation**
...
**Unit-5: Dynamics of Organizational Behaviour**
...
Refer to the `DSA` folder for unit-wise content and lab experiments.
