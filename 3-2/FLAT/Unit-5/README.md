# FLAT – Turing Machine Types and Undecidability

## Overview

Turing machine types – halting, undecidability, recursively enumerable languages, recursive languages, Post's Correspondence Problem, counter machines.
