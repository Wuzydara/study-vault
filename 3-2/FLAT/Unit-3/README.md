# FLAT – Context-Free Grammars

## Overview

Definition, derivations, leftmost/rightmost, language, sentential forms, parse trees, ambiguity. PDA – definition, languages, equivalence with CFG, acceptance by final state/empty stack, deterministic PDA.
