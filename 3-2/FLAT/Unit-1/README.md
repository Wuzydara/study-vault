# FLAT – Finite Automata

## Overview

Structural representations, automata and complexity, alphabets, strings, languages, problems. NFA – formal definition, application, epsilon transitions. DFA – definition, processing, language, conversion NFA-DFA, Moore/Mealy machines.
